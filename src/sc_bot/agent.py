    ...
    prompt = ChatPromptTemplate.from_messages(
        [
            (
                ...
                "If the output contains a structured cell type identification report or an example section for cell type\n"
                "identification from a gene list, preserve its sectional layout with a primary identity, supporting\n"
                "lineage markers, subset heterogeneity, noise notes, and a final verdict rather than flattening it into\n"
                "undifferentiated prose. This includes the Cell Type Identification from a Gene List example pattern. "
